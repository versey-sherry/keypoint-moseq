...
def _apply_to_col(df, fn, **kwargs):
    """apply function to pandas dataframe column-wise

    Parameters
    ----------
    df : pandas.DataFrame
        the dataframe to apply functions to
    fn : function
    ...
    -------
    pandas.DataFrame
        dataframe with the function applied to each column
    """
